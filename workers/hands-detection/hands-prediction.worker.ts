 ...
 class HandsPrediction {
    ...
    async configureHandModel() {
        ...
        // const mediaPipeHands = await import("./")
        // importScripts("./hand_solution_packed_assets_loader.js")
        // this._tf = await import('@tensorflow/tfjs');
        // const asd = await fetch('./hand_landmark_full.tflite')
        ...
        const detectorConfig = {
            runtime:'mediapipe',
            // solutionPath: 'http://localhost:3000/hands',
            // solutionPath: 'https://alejandrosuarez.eu/@mediapipe/hands',
            modelType: 'full',
            maxHands: 1,
        }
    ...
    async predictTrainHandPositions(image: HTMLImageElement) {
