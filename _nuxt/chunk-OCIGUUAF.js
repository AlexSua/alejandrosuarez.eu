    ...
    (function() {
      ...
      B("Promise", function(a) {
        ...
        b.all = function(f) {
          ...
          return k.done ? d([]) : new b(function(l, m) {
            ...
            var p = [], n = 0;
            do
              p.push(void 0), n++, d(k.value).M(r(p.length - 1), m), k = h.next();
            while (!k.done);
          });
        };
        return b;
      ...
      function Ma(a, b) {
        ...
        if (a.constructor === String)
          return Fa(a);
        if (a.constructor === Ka) {
          if (!b && (b = a.L) && b.constructor === Uint8Array)
            return b;
          b = a.L;
      ...
      function O(a) {
        if (a.g > a.i)
          throw Error("Tried to read past the end of the data " + a.g + " > " + a.i);
      }
      function Q(a) {
        ...
        if (128 > c)
          return O(a), d;
        if (128 <= b[a.g++] && 128 <= b[a.g++] && 128 <= b[a.g++] && 128 <= b[a.g++] && 128 <= b[a.g++])
          throw Oa();
        O(a);
        return d;
      }
      ...
      function R(a, b) {
        for (; 127 < b; )
          a.g.push(b & 127 | 128), b >>>= 7;
        a.g.push(b);
      }
      ;
      function Ta(a) {
        var b = {}, c = void 0 === b.W ? false : b.W;
        this.l = { v: void 0 === b.v ? false : b.v };
        this.W = c;
        b = this.l;
      ...
      function Za(a, b) {
        Object.isFrozen(a) || (T ? a[T] |= b : void 0 !== a.N ? a.N |= b : Object.defineProperties(a, { N: { value: b, configurable: true, writable: true, enumerable: false } }));
      }
      function $a(a) {
        var b;
        T ? b = a[T] : b = a.N;
      ...
      function ab(a) {
        return Array.isArray(a) ? !!($a(a) & 2) : false;
      }
      function bb(a) {
        if (!Array.isArray(a))
      ...
      function hb(a, b, c, d) {
        ...
        null == e && (e = db);
        if (ab(a.m))
          c && (bb(e), Object.freeze(e));
        else if (e === db || ab(e))
          e = U(e.slice()), W(a, b, e, d);
        return e;
      }
      function X(a, b, c) {
        a = V(a, b);
      ...
      function sb(a, b, c) {
        ...
        if (c)
          for (b = 0; b < c.length; b++)
            if (a = c[b], a < this.i)
              a += this.h, (d = this.m[a]) ? Array.isArray(d) && U(d) : this.m[a] = db;
            else {
      ...
      function Gb(a, b, c, d, e, g) {
        ...
        for (; f < a.length; ) {
          c = a[f++];
          for (var h = f + 1; h < a.length && "number" !== typeof a[h]; )
            h++;
          var k = a[f++];
          h -= f;
          switch (h) {
      ...
      function Ub(a, b, c) {
        ...
        try {
          ...
          b = a.g, b.h = null, b.j = 0, b.i = 0, b.g = 0, b.v = false, a.i = -1, a.h = -1, 100 > Wa.length && Wa.push(a);
        }
      }
      function Jb(a, b, c) {
      ...
      var Y = Wb(function(a, b, c) {
        ...
        if (null != b) {
          ...
          var d = b;
          d = (c = 0 > d ? 1 : 0) ? -d : d;
          0 === d ? 0 < 1 / d ? M = N = 0 : (N = 0, M = 2147483648) : isNaN(d) ? (N = 0, M = 2147483647) : 34028234663852886e22 < d ? (N = 0, M = (c << 31 | 2139095040) >>> 0) : 11754943508222875e-54 > d ? (d = Math.round(d / Math.pow(2, -149)), N = 0, M = (c << 31 | d) >>> 0) : (b = Math.floor(Math.log(d) / Math.LN2), d *= Math.pow(2, -b), d = Math.round(8388608 * d), 16777216 <= d && ++b, N = 0, M = (c << 31 | b + 127 << 23 | d & 8388607) >>> 0);
          c = M;
          a.g.push(c >>> 0 & 255);
          a.g.push(c >>> 8 & 255);
          a.g.push(c >>> 16 & 255);
        ...
        var g;
        if (za)
          (g = ya) || (g = ya = new TextDecoder("utf-8", { fatal: true })), g = g.decode(a.subarray(e, e + d));
        else {
          d = e + d;
          for (var f = [], h = null, k, l, m; e < d; )
            k = a[e++], 128 > k ? f.push(k) : 224 > k ? e >= d ? K() : (l = a[e++], 194 > k || 128 !== (l & 192) ? (e--, K()) : f.push((k & 31) << 6 | l & 63)) : 240 > k ? e >= d - 1 ? K() : (l = a[e++], 128 !== (l & 192) || 224 === k && 160 > l || 237 === k && 160 <= l || 128 !== ((g = a[e++]) & 192) ? (e--, K()) : f.push((k & 15) << 12 | (l & 63) << 6 | g & 63)) : 244 >= k ? e >= d - 2 ? K() : (l = a[e++], 128 !== (l & 192) || 0 !== (k << 28) + (l - 144) >> 30 || 128 !== ((g = a[e++]) & 192) || 128 !== ((m = a[e++]) & 192) ? (e--, K()) : (k = (k & 7) << 18 | (l & 63) << 12 | (g & 63) << 6 | m & 63, k -= 65536, f.push((k >> 10 & 1023) + 55296, (k & 1023) + 56320))) : K(), 8192 <= f.length && (h = xa(h, f), f.length = 0);
          g = xa(h, f);
        }
        W(b, c, g);
        return true;
      ...
      function oc(a) {
        return ib(a, bc, 1).map(function(b) {
          return { index: kb(b, 1), score: X(b, 2), label: null != V(b, 3) ? lb(b, 3) : void 0, displayName: null != V(b, 4) ? lb(b, 4) : void 0 };
        });
      }
      ;
      function pc(a) {
        return { x: X(a, 1), y: X(a, 2), z: X(a, 3), visibility: null != V(a, 4) ? X(a, 4) : void 0 };
      }
      function qc(a) {
      ...
      function tc(a, b) {
        ...
        if (void 0 === a.o) {
          ...
          a.j = { K: c.getAttribLocation(d, "aVertex"), J: c.getAttribLocation(d, "aTex"), qa: e };
          a.u = c.createBuffer();
          ...
          c.vertexAttribPointer(a.j.J, 2, c.FLOAT, false, 0, 0);
        ...
        c.bindBuffer(c.ARRAY_BUFFER, a.s);
        c.vertexAttribPointer(d.J, 2, c.FLOAT, false, 0, 0);
      ...
      ;
      var vc = new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 9, 1, 7, 0, 65, 0, 253, 15, 26, 11]);
      function wc(a, b) {
        return b + a;
      }
      function xc(a, b) {
        ...
        return I(function(p) {
          switch (p.g) {
            ...
            case 2:
              c = p.h;
              if ("object" === typeof window)
                return xc("createMediapipeSolutionsWasm", { locateFile: a.locateFile }), xc("createMediapipeSolutionsPackedAssets", { locateFile: a.locateFile }), f = b.filter(function(n) {
                  ...
                  return I(function(w) {
                    if (1 == w.g)
                      return n = window.createMediapipeSolutionsWasm, q = window.createMediapipeSolutionsPackedAssets, t = a, F(w, n(q), 2);
                    t.h = w.h;
                    w.g = 0;
                  });
                }), m = function() {
            ...
            case 4:
              a.i = new a.h.SolutionWasm(), a.$ = false, p.g = 0;
          }
        });
      }
      function Dc(a) {
      ...
      x.setOptions = function(a, b) {
        ...
        if (b = b || this.g.options) {
          for (var d = [], e = [], g = {}, f = C(Object.keys(a)), h = f.next(); !h.done; g = { R: g.R, S: g.S }, h = f.next()) {
            var k = h.value;
          ...
          if (0 !== d.length || 0 !== e.length)
            this.s = true, this.B = (void 0 === this.B ? [] : this.B).concat(e), this.A = (void 0 === this.A ? [] : this.A).concat(d);
        }
      };
      function Fc(a) {
        var b, c, d, e, g, f, h;
            ...
            case 3:
              ...
              for (f = g.next(); !f.done; f = g.next())
                if (h = f.value, k = c.g.inputs[h]) {
                        ...
                        for (w = 0; w < n.length; ++w) {
                          ...
                          if (t.V)
                            for (v = 0; v < t.V.length; ++v)
                              A = q.data, H = A.addClassification, E = w, u = t.V[v], z = new bc(), W(z, 2, u.score), u.index && W(z, 1, u.index), u.label && W(z, 3, u.label), u.displayName && W(z, 4, u.displayName), u = Vb(z, cc), H.call(A, E, u);
                        }
                        q = q.data;
                        break a;
                      default:
                  ...
                  switch (k.type) {
                    case "video":
                      e.pushTexture2d(Object.assign(Object.assign({}, l), { stream: m, timestamp: d }));
                      break;
                    case "detections":
                      r = l;
                      r.stream = m;
              ...
              if ("detection_list" === r.type) {
                if (p) {
                  ...
                  for (var H = p.getLandmarksList(), E = p.getClassificationsList(), u = [], z = 0; z < A.size(); ++z) {
                    ...
                    P = { ea: { ka: X(P, 1), la: X(P, 2), height: X(P, 3), width: X(P, 4), rotation: X(P, 5, 0), ia: kb(P, 6) }, Y: ib(Ub(H.get(z), ic, kc), gc, 1).map(pc), V: oc(Ub(E.get(z), dc, fc)) };
                    u.push(P);
                  }
                  A = u;
                } else
      ...
      function Ec(a, b) {
        for (var c = b.name || "$", d = [].concat(ea(b.wants)), e = new a.h.StringList(), g = C(b.wants), f = g.next(); !f.done; f = g.next())
          e.push_back(f.value);
      ...
      J("Solution", Ac);
      J("OptionType", { BOOL: 0, NUMBER: 1, ma: 2, 0: "BOOL", 1: "NUMBER", 2: "STRING" });
      function Ic(a) {
        void 0 === a && (a = 0);
      ...
      function Jc(a) {
        var b = this;
        a = a || {};
        this.g = new Ac({ locateFile: a.locateFile, files: function(c) {
          return [{ url: "hands_solution_packed_assets_loader.js" }, { simd: false, url: "hands_solution_wasm_bin.js" }, { simd: true, url: "hands_solution_simd_wasm_bin.js" }, { data: true, url: Ic(c.modelComplexity) }];
          ...
          multiHandLandmarks: { type: "proto_list", stream: "multi_hand_landmarks", transform: qc },
          multiHandWorldLandmarks: { type: "proto_list", stream: "multi_hand_world_landmarks", transform: qc },
          multiHandedness: { type: "proto_list", stream: "multi_handedness", transform: function(c) {
          ...
          onChange: function(c) {
            ...
            return I(function(f) {
              if (1 == f.g)
                return d = Ic(c), e = "third_party/mediapipe/modules/hand_landmark/" + d, F(f, Cc(b.g, d), 2);
              g = f.h;
      ...
      J("Hands", Jc);
      J("HAND_CONNECTIONS", [[0, 1], [1, 2], [2, 3], [3, 4], [0, 5], [5, 6], [6, 7], [7, 8], [5, 9], [9, 10], [10, 11], [11, 12], [9, 13], [13, 14], [14, 15], [15, 16], [13, 17], [0, 17], [17, 18], [18, 19], [19, 20]]);
...
//# sourceMappingURL=chunk-OCIGUUAF.js.map
